...
function setStrAttr(Str2){ /* 필요한 곳에서 호출 */
 ...
 function openLawType(){
	...
	document.getElementById("LawTypeButton").style.backgroundColor = "blue";
 ...
 function openContentType(){
	 ...
	 document.getElementById("ContentTypeButton").style.backgroundColor = "blue";
...
<%
 ...
 <div class = "searchtypeset">
		...
		<button class="lawsearch right" id = "ContentTypeButton" onclick = "openContentType()">조문 검색 (<%=data.size()%>)</button>
</div>
<!--  -->
 <div id = "LawType">
 <%
