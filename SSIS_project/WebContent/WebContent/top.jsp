...
$("#jomun").on("search change keyup", function () {
	   var text = this.value;
	   $("span").highlite({
	       text: text
	   });
...
<div id="mySidenav" class="sidenav">
    ...
    <div>
    	...
    	<div class="cap">
            <input class="search" name="contents" type="text" id="in" placeholder='검색어를 입력하세요.'/>
     ...
     <div id="pagesearch" class="modal">
    	페이지 내 검색
    	<div class="cap">
    	<input class="search" id="jomun" type="search" placeholder="검색어를 입력해주세요." />
    	<a href="javascript:setStrAttr(); closeNav()">
    	<button type="submit" class="search_button">
                <img src="img/png/searchbutton.png">
        </button>
        </a>
